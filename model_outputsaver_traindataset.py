# -*- coding: utf-8 -*-
"""Model_OutputSaver_TrainDataset.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1VunP7Px07dcOe9FRY4zpNXpnn2AkAfzg
"""
...
!mv "/content/AlignedCroppedImages" "/content/new_input"

!mv "/content/CroppedFaces" "/content/new_input"

!mv "/content/FaceFeatures" "/content/new_input"

!mv "/content/mtcnn/test_list" "/content/new_input"

!mv "/content/mtcnn/val_list" "/content/new_input"
...
with open('/content/new_input/val_list', 'rb') as fp:
    val_filelist = pickle.load(fp)

with open('/content/new_input/test_list', 'rb') as fp:
