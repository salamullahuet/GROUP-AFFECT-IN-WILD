# -*- coding: utf-8 -*-
"""FullDataset_FaceAttention_AlignedModel_FullTrain_4para_adam_dropout_BN_SoftmaxLr01.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Mcq2gv-Ayc3Owq5DhUCtaiEdfh2FvLaF
"""
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/Dataset/FaceAttention_AlignedModel_FullTrain_4para_adam_dropout_BN_SoftmaxLr01')
