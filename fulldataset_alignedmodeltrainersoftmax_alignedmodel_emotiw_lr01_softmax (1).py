# -*- coding: utf-8 -*-
"""FullDataset_AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Sfhv9YJzs5FN0jqZN-vaN0OpL5S1pIRu
"""
...
!mv "/content/drive/MyDrive/AlignedModel_EmotiW_lr01_Softmax" "/content/TrainedModels"
...
maxFaces = 15
numClasses = 3
aligned_path = '/content/TrainedModels/AlignedModel_EmotiW_lr01_Softmax'
...
!mv "/content/Negative" "/content/Dataset"

!mv "/content/Neutral" "/content/Dataset"

!mv "/content/Positive" "/content/Dataset"
...
!mv "/content/Dataset/Negative" "/content/Dataset/emotiw/train"
!mv "/content/Dataset/Neutral" "/content/Dataset/emotiw/train"
!mv "/content/Dataset/Positive" "/content/Dataset/emotiw/train"
...
neg_train = sorted(os.listdir('/content/Dataset/emotiw/train/'+'Negative/')) #/content/Dataset/emotiw/train/Negative
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/TrainedModels/AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax')
