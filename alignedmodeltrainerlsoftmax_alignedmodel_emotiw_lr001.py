# -*- coding: utf-8 -*-
"""AlignedModelTrainerLSoftmax_AlignedModel_EmotiW_lr001.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1XcPVC8I6RyHXh8seJjPM3O2tcZL2aMmL
"""
...
maxFaces = 15
numClasses = 3
aligned_path = '/content/drive/MyDrive/AlignedModel_EmotiW_lr001'
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/Dataset/AlignedModelTrainerLSoftmax_AlignedModel_EmotiW_lr001')
