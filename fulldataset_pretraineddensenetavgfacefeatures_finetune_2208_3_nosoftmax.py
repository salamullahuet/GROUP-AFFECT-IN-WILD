# -*- coding: utf-8 -*-
"""FullDataset_PretrainedDenseNetAvgFaceFeatures_FineTune_2208_3_NoSoftmax.ipynb
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/Dataset/PretrainedDenseNet-FineTune-2208-3-lr001-Regularized-Corrected')
