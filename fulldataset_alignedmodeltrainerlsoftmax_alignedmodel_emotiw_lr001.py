# -*- coding: utf-8 -*-
"""FullDataset_AlignedModelTrainerLSoftmax_AlignedModel_EmotiW_lr001.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1jiyNtIEV_UHWGitisdNeZWZRvmluo68K
"""
...
!mv "/content/drive/MyDrive/AlignedModel_EmotiW_lr001" "/content/TrainedModels"
...
maxFaces = 15
numClasses = 3
aligned_path = '/content/TrainedModels/AlignedModel_EmotiW_lr001'
...
neg_train = sorted(os.listdir('/content/Dataset/emotiw/train/'+'Negative/')) #('../Dataset/emotiw/train/'+'Negative/'))
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/TrainedModels/AlignedModelTrainerLSoftmax_AlignedModel_EmotiW_lr001')
