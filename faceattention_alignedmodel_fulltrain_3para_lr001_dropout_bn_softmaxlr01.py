# -*- coding: utf-8 -*-
"""FaceAttention_AlignedModel_FullTrain_3para_lr001_dropout_BN_SoftmaxLr01.ipynb
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/Dataset/FaceAttention_AlignedModel_FullTrain_3para_lr001_dropout_BN_SoftmaxLr01')
