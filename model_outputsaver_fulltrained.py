# -*- coding: utf-8 -*-
"""Model_OutputSaver_FullTrained.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1yEOHMwzPwsKfUWqD8JAARmgjZrgwJ4le
"""
...
neg_train = sorted(os.listdir('/content/new_input/'+'Negative/'))
neu_train = sorted(os.listdir('/content/new_input/'+'Neutral/'))
pos_train = sorted(os.listdir('/content/new_input/'+'Positive/'))
...
with open('/content/mtcnn/val_list', 'rb') as fp:
    val_filelist = pickle.load(fp)

with open('/content/mtcnn/test_list', 'rb') as fp:
...
class EmotiWDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = Image.open(self.root_dir+'/'+train+'/'+labelname+'/'+filename+'.jpg')
...
!mv "/content/Negative" "/content/input/Train"

!mkdir /content/new_input/train

!mv "/content/new_input/Negative" "/content/new_input/train"

!mv "/content/new_input/Neutral" "/content/new_input/train"

!mv "/content/new_input/Positive" "/content/new_input/train"

#/content/input/Train/Negative/neg_1.jpg