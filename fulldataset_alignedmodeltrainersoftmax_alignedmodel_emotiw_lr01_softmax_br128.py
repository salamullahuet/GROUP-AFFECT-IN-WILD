# -*- coding: utf-8 -*-
"""FullDataset_AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax_br128.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1mhMCcW5RRNs8qI8Hn1_2gOYP7Ba9zxwV
"""
...
!mv "/content/drive/MyDrive/AlignedModel_EmotiW_lr01_Softmax_br128" "/content/TrainedModels"
...
maxFaces = 15
numClasses = 3
aligned_path = '/content/TrainedModels/AlignedModel_EmotiW_lr01_Softmax_br128'
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/TrainedModels/AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax_br128')
