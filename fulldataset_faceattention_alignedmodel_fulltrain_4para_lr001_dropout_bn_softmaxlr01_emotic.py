# -*- coding: utf-8 -*-
"""FullDataset_FaceAttention_AlignedModel_FullTrain_4para_lr001_dropout_BN_SoftmaxLr01_EmotiC.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1NYTjawTDNRryh9L9gHSahNWfRdUTcWkn
"""
...
state_dict = torch.load('/content/drive/MyDrive/densenet_emotiw_pretrainemotic_lr001.pt', map_location=lambda storage, loc: storage)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/Dataset/FaceAttention_AlignedModel_FullTrain_4para_lr001_dropout_BN_SoftmaxLr01_EmotiC')
