# -*- coding: utf-8 -*-
"""AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax.ipynb
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/Dataset/AlignedModelTrainerSoftmax_AlignedModel_EmotiW_lr01_Softmax')
