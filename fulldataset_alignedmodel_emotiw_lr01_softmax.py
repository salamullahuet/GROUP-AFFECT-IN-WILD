# -*- coding: utf-8 -*-
"""FullDataset_AlignedModel_EmotiW_lr01_Softmax.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1nzviiYmdynCYmIaNOW6dTR4wfu3QRb_V
"""
...
data_dir = '/content/Dataset/AlignedCroppedImages/'
...
model_ft.load_state_dict(torch.load('/content/drive/MyDrive/sphere20a_20171020.pth'))
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model, '/content/Train/AlignedModel_EmotiW_lr01_Softmax')
