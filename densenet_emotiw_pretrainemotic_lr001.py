# -*- coding: utf-8 -*-
"""Densenet_Emotiw_PretrainEmotiC_lr001.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1c4pYootQSNgew5iczBd2tarDHYyGNI4M
"""
...
data_dir = '/content/Dataset/emotiw/'
...
state_dict = torch.load('/content/drive/MyDrive/densenet_emotic_lr001.pt', map_location=lambda storage, loc: storage)
    ...
    for epoch in range(num_epochs):
        ...
        for phase in range(2):
            ...
            if phase == 1 and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(model_ft.state_dict(), "/content/Dataset/densenet_emotiw_pretrainemotic_lr001.pt")
